            ...
            <div class="col-12">
                <div class="box">
                    ...
                    <div class="box-header with-border">
                        <div class="row text-right">
                            ...
                            <div class="col-md-7 text-center text-md-right">
                                <a href="http://localhost/cbo/public/admins/create" class="btn btn-primary btn-sm">
                                    <i class="mdi mdi-plus-circle mr-2"></i>Add User</a>
                    ...
                    <div id="js-user-partial-target">
                        <include-fragment src="fund-type/fetch">
        ...
        <script>
            ...
            $(function() {
                ...
                $('#search').on('click', function(e) {
                    ...
                    fetch('fund-type/search?search=' + search_keyword)
                ...
                $('.filter,.resetfilter').on('click', function() {
                    ...
                    fetch('fund-type/fetch?' + search_keyword)
                        .then(response => response.text())
                        .then(html => {
                            document.querySelector('#js-user-partial-target').innerHTML = html
                        });
            ...
            //         fetch('fund-type/fetch?search=' + search_keyword)
            //             .then(response => response.text())
            //             .then(html => {
            //                 document.querySelector('#js-user-partial-target').innerHTML = html
            //             });
            ...
            $(document).on('click', '.sendPush', function(e) {
                ...
                $.ajax({
                            url: "{{url('/')}}/fund-type/delete/"+data_id+"",
                            cache: false,
                            success: function(res) { 
                                window.location.reload();
