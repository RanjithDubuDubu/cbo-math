...
<header class="main-header">
    ...
    <a href="{{url('/dashboard')}}" class="logo">
        ...
        <b class="logo-mini" style="width:80px;padding-top:10px">
             <span class="light-logo" style="/* display: flex; *//* align-items: end; */"><img src="{{asset('assets/img/tamilnadu.953a376ad22f2c78965b.png')}}"  style="width: 67px;padding-right: 5px;" alt="logo"></span> 
         </b> 
    </a>
    <!-- Header Navbar -->
...
"></i>
                    ...
                    <ul class="dropdown-menu scale-up">
                        ...
                        <!-- Menu Body -->
                        <li class="user-body">
                            <div class="row no-gutters" style="margin-left:0px !important">
                                <div class="col-12 text-left">
                                    <a href="{{ url('admins/profile', auth()->user()->id) }}"><i
                                            class="ion ion-person"></i> @lang('pages_names.my_profile')</a>
                                </div>
                                <div class="col-12 text-left">
                                    <a href="{{ url('admins/clf_profile', auth()->user()->id) }}"><i
                                            class="ion ion-person"></i>CLF Update</a>
                                </div>
                                <div class="col-12 text-left">
                                    <a href="{{ url('admins/vo_profile', auth()->user()->id) }}"><i
                                            class="ion ion-person"></i>VO Update</a>
                                </div>
