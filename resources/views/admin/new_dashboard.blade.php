...
<!-- Start Page content -->
  ...
  <div class="row g-3" style="margin-top:30px;margin-left:0px">
                    ...
                    <div class="col-12">
                        <div class="box">
                            <div class="box-header with-border">
                                ...
                                <h5 class="font-weight-600 p-5" style="color:black;font-size:21px;padding-left: 20px !important;">Fund Tracking - Count (<span class="font-weight-600 p-5 heading-top" style="color:black;font-size:21px;    vertical-align: top;">This Month</span>)</h5>
                                @endif
                            ...
                            <div class="box-body "> 
                                ...
                                <h5 class="font-weight-600 p-5" >Pending </h5> 
                               ...
                               <img src="{{asset('assets/img/Days.png')}}" style="width:60px;" class="img-fluid" alt="">
                               <!-- <span class="info-box-icon " style="background-color:#0A7E8C;border-radius:50%;dispaly:block;margin:auto;width:50px;height:50px;line-height:54px;"><i class="ion ion-clipboard text-dark"></i></span> -->
                               <h5 class="font-weight-600 p-5" >Fund Proposed</h5> 
                               <h1 class="font-weight-600 room-count" style="  text-align: right; padding-right: 20px;font-size:38px">1</h1>
                               </div>
                               </a>
                               </div> 
                                   <div class="col-12 col-md-4">
                               ...
                               <img src="{{asset('assets/img/Days.png')}}" style="width:60px;" class="img-fluid" alt="">
                               <!-- <span class="info-box-icon " style="background-color:#0A7E8C;border-radius:50%;dispaly:block;margin:auto;width:50px;height:50px;line-height:54px;"><i class="ion ion-clipboard text-dark"></i></span> -->
                               <h5 class="font-weight-600 p-5" >Fund Disbursed</h5> 
                               <h1 class="font-weight-600 party-count" style="  text-align: right; padding-right: 20px;font-size:38px">{{$party_count}}</h1>
                               </div>
                               </a>
                               </div> 
                               ...
                               <a href="#">
                                    <div class="box p-5" style="text-align: left;border-radius:10px;padding-left: 25px !important;background: #fff !important;">
                                        <img src="{{asset('assets/img/Days.png')}}" style="width:60px;" class="img-fluid" alt=""> 
                                            <h5 class="font-weight-600 p-5" >Fund Rejected</h5> 
                                            <h1 class="font-weight-600 sports-count" style="  text-align: right; padding-right: 20px;font-size:38px">{{$sports_count}}</h1>
                                    </div>
                               </a>
                               </div>
            ...
            @if(auth()->user()->hasRole('user'))
              <div style="color:black;font-size:18px">
                               <h5 class="font-weight-600 p-5" style="color:black;font-size:21px;    PADDING-LEFT: 20PX ! IMPORTANT;">Booking Stats (<span class="font-weight-600 p-5 heading-top" style="color:black;font-size:21px;    vertical-align: top;">Last 6 Months</span>)</h5>
            ...
            <div style="color:black;font-size:18px">
                                ...
                                Fund Tracking - Amount (This Month)
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12" style="display:flex;justify-content:center;">
                                            ...
                                            <span class="info-box-icon rounded" style="background:none">
                                                <img src="{{asset('assets/img/Days.png')}}" style="width:60px;margin:auto;" class="img-fluid" alt=""></span>
                                                <div class="info-box-content" style="color: #455a80;">
                                                    <h4 class="font-weight-600 month_earnings_room" >
                                                    @if(auth()->user()->hasRole("user"))
                                                    {{$month_earnings[0]}}
                                                    @else
                                                    ₹{{$month_earnings[0]}}
                                        ...
                                        <div class="col-md-12" style="display:flex;justify-content:center;">
                                            ...
                                            <span class="info-box-icon rounded" style="background:none">
                                                <img src="{{asset('assets/img/Days.png')}}" style="width:60px;margin:auto;" class="img-fluid" alt=""></span>
                                                <div class="info-box-content" style="color: #455a80">
                                                    <h4 class="font-weight-600 month_earnings_party">
                                                    @if(auth()->user()->hasRole("user"))
                                                    {{$month_earnings[1]}}
                                                    @else
                                                    ₹{{$month_earnings[1]}}
                                        ...
                                        <div class="col-md-12" style="display:flex;justify-content:center;">
                                            ...
                                            <span class="info-box-icon rounded" style="background:none">
                                                <img src="{{asset('assets/img/Days.png')}}" style="width:60px;margin:auto;" class="img-fluid" alt=""></span>
                                                <div class="info-box-content" style="color: #455a80">
                                                    <h4 class="font-weight-600 month_earnings_sports">
                                                    @if(auth()->user()->hasRole("user"))
                                                    {{$month_earnings[2]}}
                                                    @else
                                                    ₹{{$month_earnings[2]}}
 ...
 @if(auth()->user()->hasRole('super-user'))
 <div style="color:black;font-size:18px">
                                <h5 class="font-weight-600" style="color:black;font-size:21px">Block Level Fund Tracking</h5>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <div class="box-body row">
                                ...
                                <div style="color:black;font-size:18px;padding-left:20px;padding-top:20px;display:flex">
                            <h5 class="font-weight-600" style="color:black;font-size:15px">Fund Proposed</h5> 
                            <div style="
    text-align: right;
    width: 80%;
    float: right;
"><select id="select_district" style="
...
<option value="1">ELACHIPALAYAM</option><option value="1">Block Level 1</option>
</select>
</div>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <div class="box-body row">
                                ...
                                <h5 class="font-weight-600" style="color:black;font-size:15px">Fund Disbursed</h5> 
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <div class="box-body row">
                                <div class="col-md-12 p-5" style="background:white;border-radius:15px;">
                                <div style="color:black;font-size:18px;padding-left:20px;padding-top:20px">
                                <h5 class="font-weight-600" style="color:black;font-size:15px">Fund Rejected</h5> 
...
<!-- new dashboard end -->
    ...
    get_bookings_data(data_val,data);
      ...
      const chartData = {
            labels: ['Proposed (₹)', 'Disdursed (₹)', 'Rejected (₹)'],
            datasets: [{ 
                backgroundColor: [
                    '#0A7E8C',
                    '#EC9E9C',
...
$(".apply_filter").click(function(){ 
    ...
    $.ajax({
        ...
        {  
            ...
            @if(auth()->user()->hasRole('user'))
            $(".month_earnings_room").html(res.month_earnings[0]); 
            $(".month_earnings_party").html(res.month_earnings[1]); 
            $(".month_earnings_sports").html(res.month_earnings[2]); 
            @else
            $(".month_earnings_room").html("₹"+res.month_earnings[0]); 
            $(".month_earnings_party").html("₹"+res.month_earnings[1]); 
            $(".month_earnings_sports").html("₹"+res.month_earnings[2]); 
