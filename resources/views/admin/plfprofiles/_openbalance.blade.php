...
<button type="button" class="btn btn-info btn-sm dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">@lang('view_pages.action')
    ...
    <div class="dropdown-menu">
        <a class="dropdown-item edit-bank-det" style="cursor:pointer" href="{{url('plf-profile/open-balance/edit',$result->id)}}" data-val="{{$result->id}}">
        <i class="fa fa-pencil"></i>Edit</a> 
       <a class="dropdown-item sweet-delete" style="cursor:pointer" data-id="{{$result->id}}" data-url="{{url('plf-profile/vo_profile',$result->id)}}">
        @if($result->status == 0)
