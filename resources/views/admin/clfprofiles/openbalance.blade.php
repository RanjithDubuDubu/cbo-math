            ...
            <div class="col-12">
                <div class="box">
                    ...
                    <div class="form-group">
                                            ...
                                            <option value="{{ $blocks_data->id }}" selected>
                                                        {{ $blocks_data->blockname }}</option> 
                                            </select> 
                    ...
                    <div class="append-data-items"> 
                        <div class="row text-right">
                            ...
                            <div class="col-md-7 text-center text-md-right">
                                <!-- <a href="http://localhost/cbo/public/clf-profile/vo_profile" class="btn btn-primary btn-sm">
                    ...
                    <div id="js-user-partial-target">
                        <include-fragment src="{{url('/')}}/clf-profile/list-banks/{{$clfprofile->id}}">
        ...
        <script>
            ...
            $(function() {
                ...
                $('#search').on('click', function(e) {
                    ...
                    fetch('clf-profile/search?search=' + search_keyword)
                ...
                $('.filter,.resetfilter').on('click', function() {
                    ...
                    fetch('clf-profile/fetch?' + search_keyword)
                        .then(response => response.text())
                        .then(html => {
                            document.querySelector('#js-user-partial-target').innerHTML = html
                        });
           ...
           $(document).on('change','#panchayat',function(){
             ...
             var html_data = `<div class="row text-right">
                    ...
                    <div id="js-user-partial-target">
                        <include-fragment src="{{url('/')}}/clf-profile/list-banks/${data_val}">
                            <span style="text-align: center;font-weight: bold;"> @lang('view_pages.loading')</span>
                        </include-fragment>
                    </div>`;
