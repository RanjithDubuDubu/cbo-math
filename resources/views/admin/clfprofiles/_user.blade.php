<div class="box-body no-padding">
  ...
  <!--   <th> @lang('view_pages.email')
    ...
    <tr>
    <td>{{ $i++ }} </td>
    <td> {{$result->BlockDetails->blockname}}</td>  
    <td>
    @if($result->vo_name)
    {{$result->vo_name}} 
    @else
...
<button type="button" class="btn btn-info btn-sm dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">@lang('view_pages.action')
    ...
    <div class="dropdown-menu">
        <a class="dropdown-item" href="{{url('clf-profile/clf_profile',$result->id)}}">
        <i class="fa fa-pencil"></i>Edit</a> 
        <a class="dropdown-item sweet-delete" href="{{url('clf-profile/clf_profile',$result->id)}}">
