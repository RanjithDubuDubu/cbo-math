...
<section class="content">
    ...
    <div class="col-12">
      ...
      <div class="col-12">
        ...
        <h2 style="
    margin-bottom: 20px;
">Update CLF Profile</h2>
        <ul class="nav nav-tabs">
            <li style="/* border-top-left-radius: 40px; */ border-radius: 40px;"><a class="active show" href="#basic_info" data-toggle="tab" style=" border-top-left-radius: 25px;  border-top-right-radius: 25px;">CLF Profile Information</a>
            </li>
            <li>
                <a class="" href="#vo_mapping" data-toggle="tab" style=" border-top-right-radius: 25px;">VO Mapping</a>
            </li>
            <li>
                <a class="" href="#vo_mapping" data-toggle="tab" style=" border-top-right-radius: 25px;">Executive Committe</a>
            </li>
            <li>
                <a class="" href="#office_bearers" data-toggle="tab" style=" border-top-right-radius: 25px;">Office Bearers</a>
            </li>
            <li>
            ...
            <li>
                <a class="" href="#bmmu_detail" data-toggle="tab" style=" border-top-right-radius: 25px;">BMMU Detail</a>
            </li>
        </ul>
          ...
          <div class="tab-content">  
            <div class="{{ old('tab','basic_info') == 'basic_info' ? 'active' : ''}} tab-pane" id="basic_info">	
                ...
                <div class="box p-15"> 
                  ...
                  <label for="CLF_Name">CLF Name</label>
                  <input type="text" class="form-control" id="CLF1Name" name="CLF_Name" placeholder="Enter CLF Name" data-label="CLF Name">
                  </div>
                  </div>
                  </div>
                  <div class="row">
                  <div class="col-sm-6"><div class="form-group"><label for="CLF_id">CLF ID</label><input type="number" class="form-control" id="CLF1id" name="CLF_id1" placeholder="CLF ID" data-label="CLF ID"></div></div><div class="col-sm-6"><div class="form-group"><label for="CLF_code">CLF Code</label><input type="text" class="form-control" id="CLF1code" name="CLF_code1" placeholder="Enter CLF Code" data-label="CLF Code"></div></div></div><div class="row"><div class="col-sm-6"><div class="form-group"><label for="Formation_Date">Formation Date</label><input type="date" class="form-control" id="Formation-Date" name="Formation_date" placeholder="Enter Formation Date" data-label="Formation Date"></div></div><div class="col-sm-6"><div class="form-group"><label for="PromotedBy">Promoted By</label><select id="formatted_by"><option vlaue="NRLM"> NRLM </option><option vlaue="Non Mathi"> Non Mathi </option><option vlaue="Mathi"> Mathi </option><option vlaue="Others"> Others </option></select></div></div></div><div class="row"><div class="col-sm-6"><div class="form-group"><label for="LastOfficeBearerElectedDate">Last Office Bearer Elected Date</label><input type="date" class="form-control" id="Last1Office" name="Last__Office" placeholder="Last Office Bearer Elected Date" data-label="Last Office Bearer Elected Date"></div></div><div class="col-sm-6"><div class="form-group"><label for="TenureofOBelection">Tenure of OB election</label><input type="number" class="form-control" id="TenureofOB1election" name="Promoted__by" placeholder="Tenure of OB election" data-label="Tenure of OB election"></div></div></div><div class="row"><div class="col-sm-6">
                    <div class="form-group">
                        <label for="role" style="width:100%">Registration of CLF</label>
                  <div class="switch4"><input id="is_lawn" class="check-toggle check-toggle-round-flat" type="checkbox" name="is_lawn">       \<label for="is_lawn"></label><span class="on">No</span>  <span class="off">Yes</span></div></div></div><div class="col-sm-6"><div class="form-group"><label for="RegistrationNumber">Registration Number</label><input type="number" class="form-control" id="Registration1Number" name="Registration__Number" placeholder="Enter Registration Number" data-label="Registration Number"></div></div></div><div class="row"><div class="col-sm-6"><div class="form-group"><label for="RegistrationAct">Registration Act</label><select id="Registration1Act"><option vlaue="Societies Registration Act"> Societies Registration Act </option><option vlaue="Others"> Others </option></select></div></div><div class="col-sm-6"><div class="form-group"><label for="RegistrationCopy">Registration Copy</label><input type="file" class="form-control" id="Registration1Copy" name="Registration_ofCLF" placeholder="Registration Copy" data-label="Registration Copy"></div></div></div><div class="row"><div class="col-sm-6"><div class="form-group"><label for="No.ofVOsUndertheCLF">No. of VOs Under the CLF</label><input type="text" class="form-control" id="NoofVOsUndertheCLF" name="Registration__Number" placeholder="No. of VOs Under the CLF" data-label="No. of VOs Under the CLF"></div></div><div class="col-sm-6"><div class="form-group"><label for="CLFActiveStatus">CLF Active Status</label><select id="CLFActive"><option vlaue="Active"> Active </option><option vlaue="Inactive"> Inactive </option></select></div></div></div></form></div></section> 
        ...
        <button id="search" class="btn btn-success btn-outline btn-sm py-2" type="submit">
            ...
            <div class="row text-center" style="
                ...
                <div id="js-user-partial-target" style=" width: 100%;">
                                                <include-fragment src="{{url('/')}}/clf-profile/fetch-bank-account/{{$profile->id}}">
            ...
            <div class="{{ old('tab') == 'executive_mapping' ? 'active' : ''}} tab-pane executive_mapping" id="executive_mapping">		
                <div class="box p-15">		
                  ...
                  <div class="col-sm-6">
                        <div class="form-group">
                            <label for="PromotedBy">Block Name</label>
                            <input type="text" class="form-control" id="Panchayatnamee" name="Block_name" readonly="" placeholder="Panchayat Name" data-label="Panchayat Name" value="${{$user_data['block_name']}}">
                    </div>
                </div>      
                  <div class="col-sm-6"><div class="form-group"><label for="SelectVOName">Select VO name</label>
            ...
            <div class="{{ old('tab') == 'office_bearers' ? 'active' : ''}} tab-pane" id="office_bearers">		
                <div class="box p-15">		
                   <section class="clfdetails"><div>
                    <!-- <h4> <b> Office Bearers </b></h4> -->
                </div><div class="container"><form id="exampleForm"><div class="row"><div class="col-sm-6"><div class="form-group"><label for="President">President</label><input type="text" class="form-control" id="President11" name="President11" placeholder="President " data-label="President " value=" "></div></div><div class="col-sm-6"><div class="form-group"><label for="CLF_Name">CLF Name</label><input type="text" class="form-control" id="CLF1Name" name="CLF_Name" placeholder="Enter CLF Name" data-label="CLF Name"></div></div></div><div class="row"><div class="col-sm-6"><div class="form-group"><label for="FromDate">From Date</label><input type="date" class="form-control" id="From-Date5656" name="From-Date34" placeholder=" " data-label="From Date"></div></div><div class="col-sm-6"><div class="form-group"><label for="TODate">TO Date</label><input type="date" class="form-control" id="TO-Date5" name="TO_Date55" placeholder=" " data-label="TO Date"></div></div></div><div class="row"><div class="col-sm-6"><div class="form-group"><label>Signatory</label><div class="form-check"><input type="radio" class="form-check-input" id="SignatoryYes" name="Signatory-1" data-label="Signatory " value="Yes"><label class="form-check-label" for="SignatoryYes">Yes</label></div><div class="form-check "><input type="radio" class="form-check-input" id="SignatoryNo" name="RSignatory-1" data-label="Signatory " value="No"><label class="form-check-label" for="SignatoryNo">No</label></div></div></div><div class="col-sm-6"><div class="form-group"><label for="Secretary">Secretary</label><input type="text" class="form-control" id="Secretary11" name="Secretary11" placeholder=" Secretary" data-label="Secretary"></div></div></div><div class="row"><div class="col-sm-6"><div class="form-group"><label for="FromDate">From Date</label><input type="date" class="form-control" id="From-Date909" name="From-Date656" placeholder="" data-label=" From Date"></div></div><div class="col-sm-6"><div class="form-group"><label for="TODate">TO Date</label><input type="date" class="form-control" id="TO-Date9880" name="TO-Date76" placeholder="" data-label="TO Date"></div></div></div><div class="row"><div class="col-sm-6"><div class="form-group"><label>Signatory</label><div class="form-check"><input type="radio" class="form-check-input" id="SignatoryYes1" name="Signatory-11" data-label="Signatory " value="Yes"><label class="form-check-label" for="SignatoryYes">Yes</label></div><div class="form-check "><input type="radio" class="form-check-input" id="SignatoryNo1" name="RSignatory-11" data-label="Signatory " value="No"><label class="form-check-label" for="SignatoryNo">No</label></div></div></div><div class="col-sm-6"><div class="form-group"><label for="Treasurer">Treasurer </label><input type="number" class="form-control" id="Treasurer1" name="Treasurer1" placeholder="Treasurer  " data-label="Treasurer"></div></div></div><div class="row"><div class="col-sm-6"><div class="form-group"><label for="FromDate">From Date</label><input type="date" class="form-control" id="From-Date9099" name="From-Date6566" placeholder="" data-label=" From Date"></div></div><div class="col-sm-6"><div class="form-group"><label for="TODate">TO Date</label><input type="date" class="form-control" id="TO-Date98806" name="TO-Date766" placeholder="" data-label="TO Date"></div></div></div><div class="row"><div class="col-sm-6"><div class="form-group"><label>Signatory</label><div class="form-check"><input type="radio" class="form-check-input" id="SignatoryYes12" name="Signatory-112" data-label="Signatory " value="Yes"><label class="form-check-label" for="SignatoryYes">Yes</label></div><div class="form-check "><input type="radio" class="form-check-input" id="SignatoryNo12" name="RSignatory-112" data-label="Signatory " value="No"><label class="form-check-label" for="SignatoryNo">No</label></div></div></div><div class="col-sm-6"><div class="form-group"><label for="Book Keeper">Book Keeper </label><input type="text" class="form-control" id="BookKeeper9" name="Book-Keeper" placeholder="Book Keeper " data-label="Book Keeper "></div></div></div><div class="row"><div class="col-sm-6"><div class="form-group"><label for="FromDate">From Date</label><input type="date" class="form-control" id="From-Date90992" name="From-Date65662" placeholder="" data-label=" From Date"></div></div><div class="col-sm-6"><div class="form-group"><label for="TODate">TO Date</label><input type="date" class="form-control" id="TO-Date988062" name="TO-Date7662" placeholder="" data-label="TO Date"></div></div></div>
                <div class="form-group">
                        <div class="col-12">
                            <button class="btn btn-primary btn-sm pull-right" type="submit">
                            Save
            ...
            <div class="{{ old('tab') == 'bank_account' ? 'active' : ''}} tab-pane" id="bank_account" style="background:#ededed">		
                ...
                <section class="VOdetails"><div>
                    ...
                    <div>
                        ...
                        <input type="hidden" name="clf_id" value="{{$profile->id}}" id="{{$profile->id}}">
                    </div>
                     ...
                     <div class="row bank_ifsc">
                        <div class="col-sm-6"><div class="form-group">
                        <label for="VONameasperPassbook">CLF Name as per Passbook</label>
    ...
    <div class="row text-right">
        ...
        <div class="col-4 col-md-2 text-left">
            ...
            <div class="{{ old('tab') == 'sub_committees' ? 'active' : ''}} tab-pane" id="sub_committees" style="background:#ededed">		
                ...
                </div><div class="container"><form id="exampleForm"><div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
    ...
    <div class="col-4 col-md-2 text-left">
        <button id="search" class="btn btn-success btn-outline btn-sm py-2" type="submit">
            ...
            <div class="row text-center" style="
                ...
                <div id="js-user-partial-target" style=" width: 100%;">
                                                <include-fragment src="{{url('/')}}/clf-profile/fetch-sub-committee/{{$profile->id}}">
                                            <span style="text-align: center;font-weight: bold;"> @lang('view_pages.loading')</span>
                                            </include-fragment> 
                                            </div> 
                </div>
            ...
            <div class="{{ old('tab') == 'bmmu_detail' ? 'active' : ''}} tab-pane" id="bmmu_detail">		
                <div class="box p-15">		
                  <section class="clfdetails"><div class="container"><form id="exampleForm"><div class="row"><div class="col-sm-6"><div class="form-group"><label for="BMMUDetails ">BMMU Details </label><input type="text" class="form-control" id="BMMUDetails1" name="BMMUDetails1" placeholder="BMMU Details " data-label="BMMU Details " value=" "></div></div><div class="col-sm-6"><div class="form-group"><label for="BMMUName">BMMU Name </label><input type="text" class="form-control" id="BMMUName1" name="BMMUName1" placeholder="BMMU Name " data-label="BMMU Name "></div></div></div><div class="row"><div class="col-sm-6"><div class="form-group"><label for="BMMUEstablishedDate">BMMU Established Date</label><input type="date" class="form-control" id="BMMUEstablishedDate" name="BMMUEstablishedDate" placeholder=" " data-label="BMMU Established Date"></div></div><div class="col-sm-6"><div class="form-group"><label>Whether Block Office have internet connectivity ? </label><div class="form-check"><input type="radio" class="form-check-input" id="internetconnectivity?Yes" name="internetconnectivity?" data-label="Whether Block Office have internet connectivity ?" value="Yes"><label class="form-check-label" for="RegistrationofCLFYes">Yes</label></div><div class="form-check "><input type="radio" class="form-check-input" id="internetconnectivity?No" name="internetconnectivity?" data-label="Whether Block Office have internet connectivity ?" value="No"><label class="form-check-label" for="RegistrationofCLFNo">No</label></div></div></div></div><div class="row"><div class="col-sm-6"><div class="form-group"><label>Whether Block Office have Computer?</label><div class="form-check"><input type="radio" class="form-check-input" id="OfficehaveComputer?Yes" name="OfficehaveComputer?" data-label=" Whether Block Office have Computer?" value="Yes"><label class="form-check-label" for="RegistrationofCLFYes">Yes</label></div><div class="form-check "><input type="radio" class="form-check-input" id="internetconnectivity?No" name="OfficehaveComputer?" data-label=" Whether Block Office have Computer?" value="No"><label class="form-check-label" for="OfficehaveComputer?No">No</label></div></div></div><div class="col-sm-6"><div class="form-group"><label for="WhetherBlockhavePanTanDetails ">Whether Block have Pan / Tan Details </label><input type="text" class="form-control" id="BlockhavePanTanDetails " name="BlockhavePanTanDetails" placeholder=" Whether Block have Pan / Tan Details" data-label="Whether Block have Pan / Tan Details "></div></div></div><div class="row"><div class="col-sm-6"><div class="form-group"><label for="BMMName">BMM Name</label><input type="text" class="form-control" id="BMM1Name1" name="BMMName11" placeholder="BMM Name" data-label="BMM Name"></div></div><div class="col-sm-6"><div class="form-group"><label for="ContactNumber ">Contact Number </label><input type="number" class="form-control" id="ContactNumberrfsf " name="ContactNumberfref " placeholder="Contact Number " data-label="Contact Number "></div></div></div><div class="row"><div class="col-sm-6"><div class="form-group"><label for="BCMISName">BC MIS Name</label><input type="text" class="form-control" id="BCMISName1" name="BCMISName1" placeholder="BC MIS Name " data-label="BC MIS Name"></div></div><div class="col-sm-6"><div class="form-group"><label for="ContactNumber ">Contact Number </label><input type="number" class="form-control" id="ContactNumberrfsfdd " name="ContactNumberfrefdd" placeholder="Contact Number " data-label="Contact Number "></div></div></div><div class="row"><div class="col-sm-6"><div class="form-group"><label for="BCIBCBName">BC IBCB Name</label><input type="text" class="form-control" id="BCIBCBName" name="BCIBCBName" placeholder="BC IBCB Name" data-label="BC IBCB Name"></div></div><div class="col-sm-6"><div class="form-group"><label for="ContactNumber ">Contact Number </label><input type="number" class="form-control" id="ContactNumberrfsfddd" name="ContactNumberfrefddd" placeholder="Contact Number " data-label="Contact Number "></div></div></div><div class="row"><div class="col-sm-6"><div class="form-group"><label for="Secretary Name">Secretary Name</label><input type="text" class="form-control" id="SecretaryName11" name="SecretaryName11" placeholder="Secretary Name" data-label="Secretary Name"></div></div><div class="col-sm-6"><div class="form-group"><label for="ContactNumber">Contact Number</label><input type="number" class="form-control" id="ContactNumber111" name="ContactNumber111" placeholder="Contact Number" data-label="Contact Number"></div></div></div><div class="row"><div class="col-sm-6"><div class="form-group"><label for="TreasurerName">Treasurer Name </label><input type="text" class="form-control" id="Treasurer11Name" name="Treasurer11Name" placeholder="Treasurer Name" data-label="Treasurer Name"></div></div><div class="col-sm-6"><div class="form-group"><label for="ContactNumber">Contact Number</label><input type="number" class="form-control" id="ContactNumber1111" name="ContactNumber1111" placeholder="Contact Number" data-label="Contact Number"></div></div></div></form></div></section>
...
// alert(AccountType);
        ...
        $.ajax({
                    url: '{{url('/')}}/clf-profile/stage/{{$profile->id}}/6',
                    cache: false,
                    method:'post', 
                    dataType:'json',
                    data:form_data,
                    ...
                    success: function(res) {
                        if(res.status)
                        {
                            ...
                            fetch('{{url('/')}}/clf-profile/fetch-bank-account/{{$profile->id}}')
    ...
    function edit_bank(plf_bank_id){
            popup_init();
            $.ajax({
                url: '{{url("/")}}/clf-profile/get-banks/' + plf_bank_id, // Replace with your actual route
                type: 'GET',
                success: function(response) {
                    ...
                    <div>
                     <input type="hidden" name="plf_bank_id" id="bank_ids" value="${plf_bank_id}">
                        ...
                        <input type="hidden" name="clf_id" value="{{$profile->id}}" >
                    </div>
...
$(document).on('click', '.fetchbank', function() {
    ...
    var clf_id = $("#clf_id").val();

    $.ajax({
        url: '{{url('/')}}/clf-profile/check-ifsc/' + ifscCode,
        cache: false,
        method: 'get',
        dataType: 'json',
        data: { clf_id: clf_id },
...
// popup_data(contenttts);
    ...
    $(document).ready(function(){
        ...
        // Make the AJAX call
        $.ajax({
            url: '{{url('/')}}/clf-profile/get-index-data/{{$profile->id}}', // Replace with your actual endpoint URL
    ...
    $('#banks').on('change', function() {
        ...
        if (bankId) {
            ...
            $.ajax({
                url: '{{url("/")}}/clf-profile/get-branches/' + bankId, // Replace with your actual route
                type: 'GET',
                success: function(response) {
                    console.log(response);
    ...
    $("#save").click(function(e){
        ...
        $.toast({
            ...
            $.ajax({
                    url: '{{url('/')}}/clf-profile/stage/{{$profile->id}}/1',
                    cache: false,
                    method:'post', 
                    dataType:'json',
                    data:form_data,
    ...
    $.ajax({
        url: '{{url('/')}}/clf-profile/get-shg-data',
        cache: false,
        method: 'get',
        dataType: 'json',
        data: data_val, 
            ...
            if (res.status) {
                ...
                if (mapping_count == 1) {
                    ...
                    mapButton.on("click", function() {
                        ...
                        $.ajax({
                            url: '{{url('/')}}/clf-profile/map-shg-data',
                            cache: false,
                            method: 'post',
                            dataType: 'json',
...
$(document).on('change', '.habitation', function() {
    ...
    var this_dt = $(this);
    $.ajax({
        url: '{{url('/')}}/clf-profile/get-shg-datas',
        cache: false,
        method: 'get',
        dataType: 'json',
        data: data_val, 
...
$(document).on('change', '.shg_group', function() {
    ...
    var this_dt = $(this);
    $.ajax({
        url: '{{url('/')}}/clf-profile/get-shg-member-datas',
        cache: false,
        method: 'get',
        dataType: 'json',
        data: data_val, 
    ...
    $(".save-office").click(function(){
        var form_data = new FormData($("#exampleForm4")[0]); 
            $.ajax({
                    url: '{{url('/')}}/clf-profile/stage/{{$profile->id}}/4',
                    cache: false,
                    method:'post', 
                    dataType:'json',
                    data:form_data,
    ...
    $(".save-bmmu").click(function(){
        var form_data = new FormData($("#exampleForm5")[0]); 
            $.ajax({
                    url: '{{url('/')}}/clf-profile/stage/{{$profile->id}}/5',
                    cache: false,
                    method:'post', 
                    dataType:'json',
                    data:form_data,
    ...
    $(".submit-ec").click(function(){
        var form_data = new FormData($("#exampleForm3")[0]); 
            $.ajax({
                    url: '{{url('/')}}/clf-profile/stage/{{$profile->id}}/3',
                    cache: false,
                    method:'post', 
                    dataType:'json',
                    data:form_data,
...
console.log(clf_id);
    ...
    //     $.ajax({
    //     url: '{{url('/')}}/clf-profile/get-office-bearers',
    //     cache: false,
    //     method: 'get',
    //     dataType: 'json',
    //     data: {clf_id:clf_id}, 
...
$("#fetchbank").click(function(){
    var clf_id = $("#clf_id").val();
        $.ajax({
        url: '{{url('/')}}/clf-profile/check-ifsc/'+$("#IFSC11").val()+'',
        cache: false,
        method: 'get',
        dataType: 'json',
        data: {clf_id:clf_id}, 
...
var search_keyword = '';
            ...
            $(function() {
                ...
                $('#search').on('click', function(e) {
                    ...
                    fetch('{{url('/')}}/clf-profile/fetch-bank-account/{{$profile->id}}?search=' + search_keyword)
                        .then(response => response.text())
                        .then(html => {
                            document.querySelector('#js-user-partial-target').innerHTML = html
                        });
