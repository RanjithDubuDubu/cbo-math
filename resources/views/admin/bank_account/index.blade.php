...
">PLF Bank Profile Listings</h3>
            <div class="col-12">
                <div class="box">
                    ...
                    <div class="box-header with-border">
                        <div class="row text-right">
                            ...
                            <div class="col-md-7 text-center text-md-right">
                                <a href="http://localhost/cbo/public/plf-profile/bank_profile/{{$profile->id}}" class="btn btn-primary btn-sm">
                                    <i class="mdi mdi-plus-circle mr-2"></i>Add PLF Bank Account</a>
                    ...
                    <div id="js-user-partial-target">
                        <include-fragment src="{{url('/')}}/plf-profile/bank-account/fetch/{{$profile->id}}">
        ...
        <script>
            ...
            //         fetch('plf-profile/fetch?search=' + search_keyword)
            //             .then(response => response.text())
            //             .then(html => {
            //                 document.querySelector('#js-user-partial-target').innerHTML = html
            //             });
            ...
            $(document).on('click', '.sendPush', function(e) {
                ...
                $.ajax({
                            url: "{{url('/')}}/plf-profile/delete/"+data_id+"",
                            cache: false,
                            success: function(res) { 
                                window.location.reload();
