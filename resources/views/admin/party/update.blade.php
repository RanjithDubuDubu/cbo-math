...
@endif
    ...
    ">Select Date<span class="text-danger">*</span></label>
                                                            <input class="form-control" type="date" id="from_date" name="from_date" value="{{$booking->checkin_date}}" requi#d50808="" placeholder="Enter Name" style="padding:10px">
                                                            <span class="text-danger"></span>
    ...
    ">
                                                    ...
                                                    <div class="col-md-4 col-sm-6" style="  font-size: 14px;margin-left:15px ">
                     <div class="form-group">
                        @if($booking->is_lawn)
                        <input type="checkbox" name="lawn" value="1" style=" position: relative;   top: 38px;  width: 50px;   padding: 10px !important;" checked >
                        @else
                        <input type="checkbox" name="lawn" value="1" style=" position: relative;   top: 38px;  width: 50px;   padding: 10px !important;" >
                        @endif
                       
                        <span style=" position: relative; top: 37px; font-size: 16px; color: #5f5f5f;">Add Lawn along with Party Hall
                        </span>                     
                     </div>
                    </div>
                     ...
                     <div class="col-md-12" style="padding-right: 30px !important;">
                        <div class="form-group">
                            <div class="col-12">
                                ...
                                <span class="danger-book pull-right party-msg"></span>
                            </div>
                        </div>
                    </div>
        </form>
    ...
    $('.check_availability').on('click', function(e) {
                ...
                $.ajax({
                            ...
                            success: function(res) { 
                                ...
                                `);
                                setTimeout(function() {
                                    window.location.assign('{{url("/")}}/party');
                                    }, 1000);
                                }
                                else{
                                    $(".book-now").removeClass("active");
