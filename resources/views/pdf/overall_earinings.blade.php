...
<div id="invoiceholder">
  <div id="invoice" class="effect2">
    ...
    text-align: left;
">
              <h2 style="line-height:14px;font-size: 20px;margin-bottom: 0px;"><b>{{$value['title']}} : </b></h2>
...
Paid
@else
<button class="btn btn-danger btn-sm" style="  background: red;color:white;border-color: transparent;
">
Not Paid
@endif
</button>
