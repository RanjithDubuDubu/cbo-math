...
public function decrypt($cipherText,  $key)
{
    ...
    public function get_decryption_data(){
        ...
        $data='1000356|DOM|IN|INR|100|Other|http://iasmess.dubudubutechnologies.com/success|http://iasmess.dubudubutechnologies.com/failure|SBIEPAY|$orderid|2|NB|ONLINE|ONLINE';
    ...
    public function sbi(){
       ...
       for ($i=0; $i<10; $i++)
        ...
        $MerchantId = "1000356"; 
        $key = "MBxNMjIUnjl6H6B6XPEuJCppBxt8lwX9F4rH2Jxhglg="; 
        $SuccessUrl = "http://iasmess.dubudubutechnologies.com/success"; 
        $FailUrl = "http://iasmess.dubudubutechnologies.com/failed"; 
        //requestparameter 
