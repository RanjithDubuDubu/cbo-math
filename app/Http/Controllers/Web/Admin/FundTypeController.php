...
class FundTypeController extends BaseController
{
    ...
    */
    public function index()
    {
        ...
        return view('admin.fundtype.index', compact('page', 'main_menu', 'sub_menu','sub_menu_1'));
    }
    ...
    */
    public function view(User $user)
    {
        ...
        return view('admin.fundtype.view', compact('page', 'main_menu', 'sub_menu','sub_menu_1','user','membership_tariff'));
    }
    ...
    public function getAllUser(QueryFilterContract $queryFilter)
    {
        ...
        return view('admin.fundtype._user', compact('results'));
    }
//searchUser
    ...
    public function indexDeleted()
    {
        ...
        return view('admin.fundtype.deleted-index', compact('page', 'main_menu', 'sub_menu','sub_menu_1'));
    }
    ...
    public function getAllDeletedUser(QueryFilterContract $queryFilter)
    {
        ...
        return view('admin.fundtype._deleted-user', compact('results'));
    }
...
/*inactive Users*/
    public function indexInactive()
    {
        ...
        return view('admin.fundtype.inactive-index', compact('page', 'main_menu', 'sub_menu','sub_menu_1'));
    }
    ...
    public function getAllInactiveUser(QueryFilterContract $queryFilter)
    {
        ...
        return view('admin.fundtype._inactive_user', compact('results'));
    }
/*end*/
    ...
    */
    public function create()
    {
        ...
        return view('admin.fundtype.create', compact('page', 'countries', 'main_menu', 'sub_menu','sub_menu_1'));
    }
    ...
    public function getById(User $user)
    {
        ...
        return view('admin.fundtype.update', compact('page', 'countries', 'main_menu', 'results', 'sub_menu','sub_menu_1'));
    }
   ...
   public function UserTripRequestIndex(User $user)
    {
        ...
        return view('admin.fundtype.user-request-list-new', compact('card','main_menu','sub_menu','items','sub_menu_1'));
    }
    public function UserTripRequestNew(QueryFilterContract $queryFilter, User $user)
    {
        ...
        return view('admin.fundtype.user-request-list-view-new', compact('results', 'items'));
    }
    public function UserTripRequest(QueryFilterContract $queryFilter, User $user)
    {
        ...
        return view('admin.fundtype.user-request-list', compact('results','card','main_menu','sub_menu','sub_menu_1'));
    }
    public function UserTripRequestView(QueryFilterContract $queryFilter, User $user)
    {
        ...
        return view('admin.fundtype.user-request-list-view', compact('results','items'));
    }
    ...
    if ($amount == null) {
        ...
        return view('admin.fundtype.user-payment-wallet', compact('card','main_menu','sub_menu','item','history','sub_menu_1'));
    }
...
// dd($request);
    ...
    public function UserCancelRequestIndex(User $user)
    {
        ...
        return view('admin.fundtype.cancellation', compact('results', 'page', 'main_menu', 'sub_menu', 'user','sub_menu_1'));
