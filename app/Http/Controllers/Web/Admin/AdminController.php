...
class AdminController extends BaseController
{
    ...
    */
    ...
    public function viewclfProfile(ClfProfile $profile)
    { 
        $page = trans('pages_names.admins');
        ...
        $block_details = $get_panchat->BlockDetails; 
        $ec = Ec::where('plf_id',$profile->id)->get();
        $bank_names = Bankdetails::groupBy('bank_name')->get();
        return view('admin.admin.profile1', compact('page', 'main_menu', 'sub_menu', 'sub_menu_1','user_data','block_details','profile','bank_names','ec'));
    }

    public function viewvoProfile(PlfProfile $profile)
    { 
        ...
        $get_panchat = Blocks::where('blockname',$user_data['block_name'])->first();
        $block_details = $get_panchat->BlockDetails;
        $get_panchayat_data = Panchayat::where('id',$profile->panchayat)->first();
        $habitation = Habitation::where('panchayat',$get_panchayat_data->villagename)->get();
        $ec = Ec::where('plf_id',$profile->id)->get();
        // dd($profile);
        $bank_names = Bankdetails::groupBy('bank_name')->get();
        return view('admin.admin.vo_profile', compact('page', 'main_menu', 'sub_menu', 'sub_menu_1','user_data','block_details','profile','get_panchayat_data','habitation','ec','bank_names'));
    }
