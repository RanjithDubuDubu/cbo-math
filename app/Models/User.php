...
class User extends Authenticatable implements CanSendOTPContract
{
    ...
    */
    ...
    {
        return is_valid_email($username) ? 'username' : 'mobile';
    }
    ...
    * @return \Illuminate\Database\Eloquent\Relations\hasOne
    */
    public function userCancellationFee()
    {
        return $this->hasMany(UserCancellationFee::class, 'user_id', 'id');
    }
    public function getLatestCancellationFeeDate()
    {
        $latest_cancellation_fee = $this->userCancellationFee()->latest()->first();
        return $latest_cancellation_fee ? $latest_cancellation_fee->created_at->format('Y-m-d') : '-';
    }
    ...
    */
    ...
    protected $searchable = [
        'columns' => [
            ...
            // 'users.email'=> 20,
            'users.mobile'=> 20,
            // 'users.request_number' => 20,
        ],
        // 'joins' => [
        //     'users' => ['drivers.user_id','users.id'],
        // ],
    ];
    ...
    */
    ...
    {
        return $this->hasOne(UsersMembership::class, 'user_id', 'id');
    }
